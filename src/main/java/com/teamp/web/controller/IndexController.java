...
public class IndexController {
	...
	public String openAPI(Model mv) throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("registMt","UTF-8") + "=" + URLEncoder.encode("09", "UTF-8")); /*등록된 월(MM)*/
        urlBuilder.append("&" + URLEncoder.encode("vhctyAsortCode","UTF-8") + "=" + URLEncoder.encode("1", "UTF-8")); /*차량의 종류별 구분*/
        urlBuilder.append("&" + URLEncoder.encode("registGrcCode","UTF-8") + "=" + URLEncoder.encode("10", "UTF-8")); /*광역시도 구분 코드*/
      ...
      //  urlBuilder.append("&" + URLEncoder.encode("cnmCode","UTF-8") + "=" + URLEncoder.encode("000004", "UTF-8")); /*차명 구분 위한 코드*/
        ...
        urlBuilder.append("&" + URLEncoder.encode("agrde","UTF-8") + "=" + URLEncoder.encode("2", "UTF-8")); /*등록자 연령대*/
        urlBuilder.append("&" + URLEncoder.encode("dsplvlCode","UTF-8") + "=" + URLEncoder.encode("4", "UTF-8")); /*배기량 구분을 관리*/
